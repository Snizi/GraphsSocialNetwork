    ...
    */
    ...
    var scrollOverflowHandler = {
        ...
        getState().panels.forEach(function (el) {
          if (hasClass(el.item, 'fp-noscroll') || hasClass(el.item, AUTO_HEIGHT_RESPONSIVE) && isResponsiveMode()) {
            ...
            if (shouldBeScrollable) {
              if (usingExtension('parallax')) {
                extensionCall('parallax', 'makeScrollable', el.item);
              } else {
      ...
      shouldBeScrollable: function shouldBeScrollable(item) {
        // Parallax creates a wrapper with the class `fp-overflow` wrapping 
        // the content instead of adding the class in the section/slide
        var scrollableItem = $(OVERFLOW_SEL, item)[0] || item;
        return scrollableItem.scrollHeight > win.innerHeight;
      },
